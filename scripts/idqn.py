...
def main(env_name, lr, gamma, batch_size, buffer_limit, log_interval, max_episodes,
    ...
    model_dir = '../models/'+env_name+'_idqn_'+str(max_episodes)+'.pth'
    torch.save(q.state_dict(), model_dir)
...
if __name__ == '__main__':
    ...
    if USE_WANDB:
        ...
        wandb.init(project='minimal-marl', name=args.env_name+'_idqn_'+str(args.max_episodes), config={'algo': 'idqn', **kwargs}, monitor_gym=True)
