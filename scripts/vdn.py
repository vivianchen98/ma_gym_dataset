...
def main(env_name, lr, gamma, batch_size, buffer_limit, log_interval, max_episodes, max_epsilon, min_epsilon,
    ...
    model_dir = '../models/'+env_name+'_vdn_'+str(max_episodes)+'.pth'
...
if __name__ == '__main__':
    ...
    if USE_WANDB:
        ...
        wandb.init(project='minimal-marl', name=args.env_name+'_vdn_'+str(args.max_episodes), config={'algo': 'vdn', **kwargs})
